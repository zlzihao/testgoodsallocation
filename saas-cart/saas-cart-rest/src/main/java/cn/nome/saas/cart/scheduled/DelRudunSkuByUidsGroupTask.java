 ...
 * @author chentaikuang
 */
public class DelRudunSkuByUidsGroupTask extends RecursiveTask<String> {
    ...
    public DelRudunSkuByUidsGroupTask(int start, String[] uidsArr, boolean delDbSizeSku, CartServiceManager cartServiceManager) {
        this.start = start;
    ...
    protected String compute() {
        ...
        if (canCompute) {
            ...
            for (int i = start; i < end; i++) {
                int uid = Integer.valueOf(uidsArr[i]);
            ...
            int mid = (start + end) / 2;
            DelRudunSkuByUidsGroupTask leftTask = new DelRudunSkuByUidsGroupTask(start, uidsArr, delDbSizeSku, cartServiceManager);
            DelRudunSkuByUidsGroupTask rightTask = new DelRudunSkuByUidsGroupTask(mid, uidsArr, delDbSizeSku, cartServiceManager);
