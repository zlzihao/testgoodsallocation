 ...
 * @author chentaikuang
 */
@Api(description = "结算控制器v3入口")
@RestController
@RequestMapping("/user/{uid}/checkout/v3")
@Validated
public class CalcV3Controller extends BaseController {
    ...
    public Result doCalc(@RequestHeader(CommonHeader.corpId) Integer corpId,
        ...
        CartCalcWrap resultModel = calcServiceManager.calcV3(calcModel);
        if (resultModel == null) {
