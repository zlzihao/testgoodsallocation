package cn.nome.saas.cart.rest.handler;
...
import cn.nome.saas.cart.component.LangComponent;
...
public class RequestResponseAdvice implements ResponseBodyAdvice<Object> {
	...
	public Result handleException(HttpServletRequest request, Exception ex) {
		ex.printStackTrace();
		return ResultUtil.handleFailtureReturn(Constants.RESULT_SYS, ex.getMessage());
	}
