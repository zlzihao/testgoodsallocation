...
public class AllocationDataSourceConfig {
	...
	static final String PACKAGE = "cn.nome.saas.allocation.repository.old.allocation.dao";
	static final String MAPPER_LOCATION = "classpath:mapper/old/allocation/*.xml";
