...
/**
 * AllocationClothingResultDO
 *
 * @author Bruce01.fan
 * @date 2019/12/12
 */
public class AllocationClothingResultDO extends ToString {
    ...
    private double beforeFullRate;

    private double afterFullRate;
    ...
    public double getBeforeFullRate() {
        return beforeFullRate;
    }

    public void setBeforeFullRate(double beforeFullRate) {
        this.beforeFullRate = beforeFullRate;
    }

    public double getAfterFullRate() {
        return afterFullRate;
    }

    public void setAfterFullRate(double afterFullRate) {
