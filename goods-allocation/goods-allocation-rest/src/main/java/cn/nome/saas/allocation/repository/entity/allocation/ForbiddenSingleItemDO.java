 ...
 * @date 2019/5/26
 */
public class ForbiddenSingleItemDO extends ToString {
     ...
     * 单店禁配类型
     */
    public static final int TYPE_FORBIDDEN_SINGLE = 1;

    /**
     * 全局禁配类型
     */
    public static final int TYPE_FORBIDDEN_GLOBAL = 2;
     ...
     * 店铺代码与对象值
     */
    private String concatShopCodeTypeValue;

    public String getConcatShopCodeTypeValue() {
        return concatShopCodeTypeValue;
    }

    public void setConcatShopCodeTypeValue(String concatShopCodeTypeValue) {
        this.concatShopCodeTypeValue = concatShopCodeTypeValue;
    }
    ...
    public int getTypeForbidden() {
        return typeForbidden;
    }

    public void setTypeForbidden(int typeForbidden) {
        this.typeForbidden = typeForbidden;
    }
