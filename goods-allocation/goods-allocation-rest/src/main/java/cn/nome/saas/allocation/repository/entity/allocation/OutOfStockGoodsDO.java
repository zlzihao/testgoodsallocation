 ...
 * @date 2019/6/20
 */
public class OutOfStockGoodsDO extends ToString{
    ...
    private Double avgSaleQty = 0D; // 日均销

    private Integer applyStockQty = 0; // 在配库存
    ...
    private Integer invalidSkcFlag = 0; // 非有效skc标记 (0-有效 1-无效)
    ...
    private Integer remainStockQty; //剩余库存（需求方：需求库存 - 调拨库存； 供给方：供给库存 - 调拨库存  ）
    ...
    public Integer getInvalidSkcFlag() {
        return invalidSkcFlag;
    }

    public void setInvalidSkcFlag(Integer invalidSkcFlag) {
        this.invalidSkcFlag = invalidSkcFlag;
    }
